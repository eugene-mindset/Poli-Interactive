...
LOAD DATA LOCAL INFILE './data/congress.csv'
INTO TABLE Congress
FIELDS
    TERMINATED BY '||'
    LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/member.csv'
INTO TABLE Member
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/role.csv'
INTO TABLE Role
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/area.csv'
INTO TABLE Area
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/bill.csv'
INTO TABLE Bill
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/subject.csv'
INTO TABLE Subject
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/bill_subject.csv'
...
LOAD DATA LOCAL INFILE './data/sponsor.csv'
INTO TABLE Sponsor
FIELDS
  TERMINATED BY '||'
  LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './data/cosponsor.csv'
...
LOAD DATA LOCAL INFILE './data/vote.csv'
INTO TABLE Vote
FIELDS
    TERMINATED BY '||'
    LINES TERMINATED BY '\n'
